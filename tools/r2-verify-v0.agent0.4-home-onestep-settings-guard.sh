...
export EXPECTED_VERSION_CODE="55"
export EXPECTED_VERSION_NAME="0.7.4"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.agent0.4-home-onestep-settings-guard"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0AGENT04_HOME_ONESTEP_SETTINGS_GUARD"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0AGENT04_HOME_ONESTEP_SETTINGS_GUARD"
...
{
  echo
  echo "## agent0.4 extra offline checks"
  ...
  grep -R -q 'v0.agent0.4-home-onestep-settings-guard' "$decode_dir" || { echo "error: agent0.4 variant marker missing" >&2; exit 1; }
  ...
  echo "agent04_extra_offline_checks=ok"
} 2>&1 | tee -a "$report"
