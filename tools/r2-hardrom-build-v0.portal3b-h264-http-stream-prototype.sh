...
SOURCE_VARIANT="v0.portal3a-webrtc-capability-probe"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.portal3a-webrtc-capability-probe.sparse.img}"
SOURCE_SPARSE_SHA256="5f399322d4e5955edaeb4d1114b2e43384c86f45645e225c8873010fd435b820"
SOURCE_SYSTEM_B="${SOURCE_SYSTEM_B:-${ROOT_DIR}/hard-rom/build/system-otatrust-v0.portal3a-webrtc-capability-probe.img}"
SOURCE_SYSTEM_B_SHA256="70b753d1bf7af25d5131782f554860a81297afd6f9dc17ed1629696e101d31e0"
...
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-23 18:00:00 +0800; invalidates Smartisax package scan/cache after H.264 stream prototype APK update}"

PURPOSE="Add the first Smartisax Portal H.264 Annex-B HTTP stream prototype on top of live-proven v0.portal3a while retaining the framebuffer services.jar policy and PNG/input fallback."
RESULT_NAME="PASS_BUILD_V0PORTAL3B_H264_HTTP_STREAM_PROTOTYPE"
...
Builds a system_b-only Smartisax Portal candidate on top of v0.portal3a. It
...
/api/video/h264 endpoint while retaining /api/media/capabilities, PNG screen,
and privileged input.
It rebuilds system_b AVB/FEC roots=2 and patches that system_b image into the
v0.portal3a sparse super. It does not touch a live device.
USAGE
}
