...
export EXPECTED_VERSION_CODE="31"
export EXPECTED_VERSION_NAME="0.6.14"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal5n-latency-budget-queue-collapse"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal5n_latency_budget_queue_collapse"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal5n_latency_budget_queue_collapse"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5N_LATENCY_BUDGET_QUEUE_COLLAPSE"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5N_LATENCY_BUDGET_QUEUE_COLLAPSE"
