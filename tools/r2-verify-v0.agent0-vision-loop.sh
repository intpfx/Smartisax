...
export EXPECTED_VERSION_CODE="51"
export EXPECTED_VERSION_NAME="0.7.0"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.agent0-vision-loop"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0AGENT0_VISION_LOOP"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0AGENT0_VISION_LOOP"
...
{
  echo
  echo "## agent0 extra offline checks"
  ...
  echo "agent0_extra_offline_checks=ok"
} 2>&1 | tee -a "$report"
