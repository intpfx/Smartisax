...
VARIANT="${VARIANT:-v0.portal4b-mp4-control-polish}"
SOURCE_VARIANT="v0.portal4a-webrtc-rtp-probe"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.portal4a-webrtc-rtp-probe.sparse.img}"
SOURCE_SPARSE_SHA256="a1c24a085f604966ddd500a7cb88a26aad81697efc524fbe83d287fbb4243ae3"
SOURCE_SYSTEM_B="${SOURCE_SYSTEM_B:-${ROOT_DIR}/hard-rom/build/system-otatrust-v0.portal4a-webrtc-rtp-probe.img}"
SOURCE_SYSTEM_B_SHA256="a9ae296781e159bd353ea77df6582155a1b08743eddcd8f997ccf06382c342da"
...
PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a3a91c0}"
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-23 23:00:00 +0800; invalidates Smartisax package scan/cache after Portal MP4 live-control polish APK update}"

PURPOSE="Polish the Smartisax Portal direct-LAN MP4 live playback and pointer-control path on top of live-proven v0.portal4a while retaining WebRTC offer, RTP dump, raw H.264, PNG, and privileged input diagnostics."
RESULT_NAME="PASS_BUILD_V0PORTAL4B_MP4_CONTROL_POLISH"
...
Builds a system_b-only Smartisax Portal candidate on top of v0.portal4a. It
updates only the Smartisax priv-app APK and privapp whitelist, keeps the narrow
READ_FRAME_BUFFER services.jar policy unchanged, and adds token-gated
/api/webrtc/offer and /api/rtp/h264 diagnostic endpoints intact. The accepted
/api/video/mp4 browser playback path becomes the default Start Live route, and
raw /api/video/h264, /api/media/capabilities, PNG screen, and privileged input
stay intact.
It rebuilds system_b AVB/FEC roots=2 and patches that system_b image into the
v0.portal4a sparse super. It does not touch a live device.
USAGE
}
