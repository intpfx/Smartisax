...
VARIANT="${VARIANT:-v0.wadb2.2-smartisax-wireless-adb-binder-transact}"
SOURCE_VARIANT="v0.wadb2.1-smartisax-wireless-adb-reflection-pmcache"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.wadb2.1-smartisax-wireless-adb-reflection-pmcache.sparse.img}"
SOURCE_SPARSE_SHA256="a2c9ed0d1ff66ab14827154f7347c91c30d3701136c02279649c70ccff09f4c7"
SOURCE_SYSTEM_B_SHA256="968ea3ddce3a468e666ad4ba69945d412780cc4bf9e4987fc86469bcf9866290"
...
PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a39e740}"
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-22 22:00:00 +0800; invalidates Smartisax package scan/cache after Binder transact wireless ADB repair}"

PURPOSE="Repair Smartisax wireless ADB after v0.wadb2.1 by replacing hidden IAdbManager reflection with raw Binder transact calls."
RESULT_NAME="PASS_BUILD_V0WADB22_SMARTISAX_WIRELESS_ADB_BINDER_TRANSACT"

usage() {
  cat <<'USAGE'
Usage:
  tools/r2-hardrom-build-v0.wadb2.2-smartisax-wireless-adb-binder-transact.sh

Builds a system_b-only candidate on top of v0.wadb2.1. It updates the Smartisax
priv-app APK in place and keeps the v0.wadb2.1 services.jar current-Wi-Fi plus
priv-app package-cache policy unchanged. It rebuilds system_b AVB/FEC roots=2
and patches that system_b image into the v0.wadb2.1 sparse super. It does not
touch a live device.
USAGE
}
