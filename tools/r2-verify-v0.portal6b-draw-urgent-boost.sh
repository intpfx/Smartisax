...
export EXPECTED_VERSION_CODE="45"
export EXPECTED_VERSION_NAME="0.6.28"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal6b-draw-urgent-boost"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL6B_DRAW_URGENT_BOOST"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL6B_DRAW_URGENT_BOOST"
