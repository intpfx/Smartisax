...
export EXPECTED_VERSION_CODE="44"
export EXPECTED_VERSION_NAME="0.6.27"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal6a-marker-draw-sync"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal6a_marker_draw_sync"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal6a_marker_draw_sync"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL6A_MARKER_DRAW_SYNC"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL6A_MARKER_DRAW_SYNC"
