...
export EXPECTED_VERSION_CODE="27"
export EXPECTED_VERSION_NAME="0.6.10"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal5k-frame-pump-continuity"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal5k_frame_pump_continuity_1080p30_first"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal5k_frame_pump_continuity_1080p30_first"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5K_FRAME_PUMP_CONTINUITY"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5K_FRAME_PUMP_CONTINUITY"
