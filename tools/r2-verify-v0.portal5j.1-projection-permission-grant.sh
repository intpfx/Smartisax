...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5J1_PROJECTION_PERMISSION_GRANT"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5J1_PROJECTION_PERMISSION_GRANT"
