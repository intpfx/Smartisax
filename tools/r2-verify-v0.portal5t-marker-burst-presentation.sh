...
export EXPECTED_VERSION_CODE="37"
export EXPECTED_VERSION_NAME="0.6.20"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal5t-marker-burst-presentation"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal5t_marker_burst_presentation"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal5t_marker_burst_presentation"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5T_MARKER_BURST_PRESENTATION"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5T_MARKER_BURST_PRESENTATION"
