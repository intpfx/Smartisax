...
SOURCE_VARIANT="v0.agent0.8-onestep-a11y-nodes"
SOURCE_SYSTEM_B="${SOURCE_SYSTEM_B:-${ROOT_DIR}/hard-rom/build/system-otatrust-v0.agent0.8-onestep-a11y-nodes.img}"
SOURCE_SYSTEM_B_SHA256="${SOURCE_SYSTEM_B_SHA256:-59513487018c33383f24c9f163238192f82a596c65d3b89db6ed8a93b0c5ffdc}"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.agent0.8-onestep-a11y-nodes.sparse.img}"
SOURCE_SPARSE_SHA256="${SOURCE_SPARSE_SHA256:-3f0ea7fb8f3bed0dcf9e8c3582e40c02f0b2db59991ef606a887b8d7cd979f8b}"
...
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-07-06 07:00:00 +0800; invalidates Smartisax package scan cache after Agent v0.7.9 worker/a11y-target status update}"

PURPOSE="Agent v0.9 repair on top of live v0.agent0.8: reconcile dead Agent workers in status and surface Agent-visible One Step/Settings Accessibility target counts while reusing the v0.8 Sidebar app-node patch."
RESULT_NAME="PASS_BUILD_V0AGENT09_WORKER_A11Y_TARGETS"
...
Build the v0.agent0.9 Agent diagnostic repair on top of live-proven
v0.agent0.8-onestep-a11y-nodes. This updates SmartisaxShell and replaces only:

  /system/priv-app/Sidebar/Sidebar.apk

with the already-built v0.agent0.8 classes.dex-only Sidebar patch that exposes
dynamic top app strip items as clickable Accessibility nodes. The script
rebuilds system_b AVB/FEC and patches it into the v0.agent0.8 sparse super. It
