...
SOURCE_VARIANT="v0.wadb1-smartisax-priv-wireless-adb"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.wadb1-smartisax-priv-wireless-adb.sparse.img}"
SOURCE_SPARSE_SHA256="12e0a42afe1a39fa63948568a7bce84804052019584eaacb46b37151c6ae18cc"
SOURCE_SYSTEM_B_SHA256="013d335d8ed3bda9420f553b62eb5ca7de0c23cb21b9d3a35da664e8dfee0f8b"
...
SERVICES_JAR_CANDIDATE="${SERVICES_JAR_CANDIDATE:-${ROOT_DIR}/hard-rom/build/framework/services-wadb2-current-wifi-adb.jar}"
BASE_SERVICES_JAR_SHA256="0f8991d4f9d7f0bf65407d62c180a8e98852135584f05cda5a57cba955fae9b6"
...
PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a39cb20}"
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-22 21:00:00 +0800; invalidates Smartisax package scan/cache after wireless ADB bridge update}"

PURPOSE="Teach system_server to resolve Smartisax's current-Wi-Fi sentinel BSSID before allowing wireless ADB, and update Smartisax to send that sentinel from its privileged entry."
RESULT_NAME="PASS_BUILD_V0WADB2_SMARTISAX_WIRELESS_ADB_CURRENT_WIFI"

usage() {
  cat <<'USAGE'
Usage:
  tools/r2-hardrom-build-v0.wadb2-smartisax-wireless-adb-current-wifi.sh

Builds a system_b-only candidate on top of live-proven v0.wadb1. It updates the
Smartisax priv-app APK in place, replaces /system/framework/services.jar with
the v0.wadb2 current-Wi-Fi sentinel policy, rebuilds system_b AVB/FEC roots=2,
and patches that system_b image into the v0.wadb1 sparse super. It does not
touch a live device.
USAGE
}
