...
export EXPECTED_VERSION_CODE="29"
export EXPECTED_VERSION_NAME="0.6.12"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal5l-touch-photon-move-stream"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal5l_touch_photon_marker_move_stream"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal5l_touch_photon_marker_move_stream"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5L_TOUCH_PHOTON_MOVE_STREAM"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5L_TOUCH_PHOTON_MOVE_STREAM"
