...
VARIANT="${VARIANT:-v0.portal1-smartisax-lan-portal-noop}"
SOURCE_VARIANT="v0.wadb2.2-smartisax-wireless-adb-binder-transact"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.wadb2.2-smartisax-wireless-adb-binder-transact.sparse.img}"
SOURCE_SPARSE_SHA256="231b064ad45804483654a3ae4d629e83952f0518c941d9de4366fa3c1a7fdb01"
SOURCE_SYSTEM_B="${SOURCE_SYSTEM_B:-${ROOT_DIR}/hard-rom/build/system-otatrust-v0.wadb2.2-smartisax-wireless-adb-binder-transact.img}"
SOURCE_SYSTEM_B_SHA256="e5e152997ac515d0fd8b16c8929bd3ca655a6bf30de28730d6915a9d1f9d2376"
...
PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a3a03a0}"
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-22 23:00:00 +0800; invalidates Smartisax package scan/cache after LAN portal service addition}"

PURPOSE="Add the first Smartisax LAN Device Portal noop service on top of live-proven v0.wadb2.2 while retaining wireless ADB and services.jar behavior."
RESULT_NAME="PASS_BUILD_V0PORTAL1_SMARTISAX_LAN_PORTAL_NOOP"
...
Builds a system_b-only candidate on top of live-proven v0.wadb2.2. It updates
the Smartisax priv-app APK in place, adds the LAN DevicePortalService, and keeps
the v0.wadb2.2 services.jar current-Wi-Fi plus priv-app package-cache behavior
unchanged. It rebuilds system_b AVB/FEC roots=2 and patches that system_b image
into the v0.wadb2.2 sparse super. It does not touch a live device.
USAGE
}
