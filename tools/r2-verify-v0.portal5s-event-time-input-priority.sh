...
export EXPECTED_VERSION_CODE="36"
export EXPECTED_VERSION_NAME="0.6.19"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal5s-event-time-input-priority"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal5s_event_time_input_priority"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal5s_event_time_input_priority"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5S_EVENT_TIME_INPUT_PRIORITY"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5S_EVENT_TIME_INPUT_PRIORITY"
