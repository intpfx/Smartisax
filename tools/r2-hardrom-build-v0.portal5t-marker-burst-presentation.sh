...
SOURCE_SYSTEM_B_WORK="${ROOT_DIR}/hard-rom/work/v0.portal5t-marker-burst-presentation/source/system-otatrust-v0.portal5s-event-time-input-priority.img"
...
export VARIANT="v0.portal5t-marker-burst-presentation"
...
export PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a443000}"
export PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-07-01 02:49:20 +0800; invalidates Smartisax package scan/cache after marker-burst Chrome presentation Portal repair}"
export PURPOSE="${PURPOSE:-Reduce Chrome presentation/RVFC gaps and marker touch-to-photon tail latency by keeping a short marker-visible burst of input-priority projection frames after marker draw.}"
export RESULT_NAME="${RESULT_NAME:-PASS_BUILD_V0PORTAL5T_MARKER_BURST_PRESENTATION}"
