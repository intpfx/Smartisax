...
VARIANT="${VARIANT:-v0.portal2-smartisax-remote-screen-control}"
SOURCE_VARIANT="v0.portal1-smartisax-lan-portal-noop"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.portal1-smartisax-lan-portal-noop.sparse.img}"
SOURCE_SPARSE_SHA256="8af6630b1911e9c697b02b4cca458f0d6609f8900046063c4372494d4a1ddd76"
SOURCE_SYSTEM_B="${SOURCE_SYSTEM_B:-${ROOT_DIR}/hard-rom/build/system-otatrust-v0.portal1-smartisax-lan-portal-noop.img}"
SOURCE_SYSTEM_B_SHA256="7cd993f4fe8afaf352b7d03bea55863c36ad7a5ce06bc312dc453eaac98687ce"
...
PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a393920}"
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-22 21:30:56 +0800; invalidates Smartisax package scan/cache after remote screen/control portal addition}"

PURPOSE="Add token-gated Smartisax LAN remote screen PNG streaming and pointer input control on top of live-proven v0.portal1 while retaining wireless ADB, Keyguard, PackageManager, and portal pairing boundaries."
RESULT_NAME="PASS_BUILD_V0PORTAL2_SMARTISAX_REMOTE_SCREEN_CONTROL"
...
Builds a system_b-only candidate on top of live-proven v0.portal1. It updates
the Smartisax priv-app APK in place, adds token-gated /api/screen.png and
/api/input portal paths, and keeps the v0.portal1 services.jar, wireless ADB,
Keyguard, and PackageManager behavior unchanged. It rebuilds system_b AVB/FEC
roots=2 and patches that system_b image into the v0.portal1 sparse super. It
does not touch a live device.
USAGE
}
