...
export EXPECTED_VERSION_CODE="21"
export EXPECTED_VERSION_NAME="0.6.4"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal5f-webrtc-datachannel-input"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5F_WEBRTC_DATACHANNEL_INPUT"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5F_WEBRTC_DATACHANNEL_INPUT"
