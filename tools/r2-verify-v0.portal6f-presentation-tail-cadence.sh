...
export EXPECTED_VERSION_CODE="49"
export EXPECTED_VERSION_NAME="0.6.32"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal6f-presentation-tail-cadence"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal6f_presentation_tail_cadence"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal6f_presentation_tail_cadence"
...
export EXPECTED_WEBRTC_ENCODER_TRANSPORT_REASON_MARKER="portal6f_presentation_tail_cadence"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL6F_PRESENTATION_TAIL_CADENCE"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL6F_PRESENTATION_TAIL_CADENCE"
