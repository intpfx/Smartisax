...
VARIANT="${VARIANT:-v0.portal3a-webrtc-capability-probe}"
SOURCE_VARIANT="v0.portal2.3-smartisax-framebuffer-grant"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.portal2.3-smartisax-framebuffer-grant.sparse.img}"
SOURCE_SPARSE_SHA256="500b37a0e080b94dc50ae6d59c8265982998e4e6e8a3f98301e34472c347ef4b"
SOURCE_SYSTEM_B="${SOURCE_SYSTEM_B:-${ROOT_DIR}/hard-rom/build/system-otatrust-v0.portal2.3-smartisax-framebuffer-grant.img}"
SOURCE_SYSTEM_B_SHA256="0fb6bb063aeb72ee84a60ad5f5a0afd61146df06e6a03fc7d4fa2c0ed85f7a7e"
...
PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a3a3d00}"
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-23 16:00:00 +0800; invalidates Smartisax package scan/cache after WebRTC capability probe APK update}"

PURPOSE="Add the first Smartisax Portal WebRTC/H.264 capability probe on top of live-proven v0.portal2.3 while retaining the framebuffer services.jar policy."
RESULT_NAME="PASS_BUILD_V0PORTAL3A_WEBRTC_CAPABILITY_PROBE"
...
Builds a system_b-only Smartisax Portal candidate on top of v0.portal2.3. It
updates only the Smartisax priv-app APK and privapp whitelist, keeps the narrow
READ_FRAME_BUFFER services.jar policy unchanged, and adds the token-gated
/api/media/capabilities probe plus browser-side WebRTC/WebCodecs capability UI.
It rebuilds system_b AVB/FEC roots=2 and patches that system_b image into the
v0.portal2.3 sparse super. It does not touch a live device.
USAGE
}
