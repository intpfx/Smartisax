...
export EXPECTED_VERSION_CODE="48"
export EXPECTED_VERSION_NAME="0.6.31"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal6e-encoder-transport-burst"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal6e_encoder_transport_burst"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal6e_encoder_transport_burst"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL6E_ENCODER_TRANSPORT_BURST"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL6E_ENCODER_TRANSPORT_BURST"
