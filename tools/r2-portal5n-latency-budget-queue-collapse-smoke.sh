...
export VARIANT="${VARIANT:-v0.portal5n-latency-budget-queue-collapse}"
export OUT_DIR="${OUT_DIR:-${ROOT_DIR}/hard-rom/inspect/${VARIANT}/portal-latency-budget-queue-collapse-smoke-live}"
export PROFILES="${PROFILES:-1080p30-texture 1080p60-texture}"
export SUMMARY_TITLE="${SUMMARY_TITLE:-v0.portal5n Latency Budget Queue-collapse WebRTC Smoke}"
