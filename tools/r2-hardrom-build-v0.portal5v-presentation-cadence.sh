...
SOURCE_SYSTEM_B_WORK="${ROOT_DIR}/hard-rom/work/v0.portal5v-presentation-cadence/source/system-otatrust-v0.portal5s-event-time-input-priority.img"
...
export VARIANT="v0.portal5v-presentation-cadence"
...
export PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a445000}"
export PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-07-01 05:00:00 +0800; invalidates Smartisax package scan/cache after Portal receiver presentation cadence repair}"
export PURPOSE="${PURPOSE:-Reduce Chrome presentation/RVFC gaps by forcing browser receiver playoutDelayHint=0 where supported, applying motion contentHint, and carrying RTC playout/jitter/drop/freeze diagnostics through strict smoke output.}"
export RESULT_NAME="${RESULT_NAME:-PASS_BUILD_V0PORTAL5V_PRESENTATION_CADENCE}"
