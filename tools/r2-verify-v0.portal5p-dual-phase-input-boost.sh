...
export EXPECTED_VERSION_CODE="33"
export EXPECTED_VERSION_NAME="0.6.16"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal5p-dual-phase-input-boost"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal5p_dual_phase_input_boost"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal5p_dual_phase_input_boost"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5P_DUAL_PHASE_INPUT_BOOST"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5P_DUAL_PHASE_INPUT_BOOST"
