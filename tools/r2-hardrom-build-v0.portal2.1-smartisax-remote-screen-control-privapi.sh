...
VARIANT="${VARIANT:-v0.portal2.1-smartisax-remote-screen-control-privapi}"
SOURCE_VARIANT="v0.portal2-smartisax-remote-screen-control"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.portal2-smartisax-remote-screen-control.sparse.img}"
SOURCE_SPARSE_SHA256="24a2955b962595509e6799d79da299b068480815e81ddffa2a221b77a71a2cbc"
SOURCE_SYSTEM_B="${SOURCE_SYSTEM_B:-${ROOT_DIR}/hard-rom/build/system-otatrust-v0.portal2-smartisax-remote-screen-control.img}"
SOURCE_SYSTEM_B_SHA256="8b6add09cf63da59cfe93cda433180fff0622a7be87ec14a145594e7abab3317"
...
PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a39410c}"
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-22 22:05:00 +0800; invalidates Smartisax package scan/cache after privileged API screen/control repair}"

PURPOSE="Repair Smartisax LAN remote screen/control by replacing app-internal kp calls with privileged SurfaceControl screenshot and InputManager injection APIs on top of v0.portal2."
RESULT_NAME="PASS_BUILD_V0PORTAL21_SMARTISAX_REMOTE_SCREEN_CONTROL_PRIVAPI"

usage() {
  cat <<'USAGE'
Usage:
  tools/r2-hardrom-build-v0.portal2.1-smartisax-remote-screen-control-privapi.sh

Builds a system_b-only repair candidate on top of v0.portal2. It updates the
Smartisax priv-app APK and privapp whitelist in place, keeps the same portal
HTTP pairing contract, and changes screen/input internals from app-visible kp
process calls to privileged SurfaceControl/InputManager APIs. It keeps
services.jar unchanged, rebuilds system_b AVB/FEC roots=2, and patches that
system_b image into the v0.portal2 sparse super. It does not touch a live
device.
USAGE
}
