...
usage() {
  cat <<'USAGE'
Usage:
  tools/r2-portal-smoke-v0.portal4b.sh --url http://<r2-ip>:37601 --code <pairing-code>
...
checks = {
    "portalVersion": "0.5.4",
    "webrtc": "signaling-rtp-probe-mp4-live-polish",
    "webrtcCodec": "H264",
...
print("status_portal_version=0.5.4")
print("status_webrtc=signaling-rtp-probe-mp4-live-polish")
...
if data.get("portalVersion") != "0.5.4":
    raise SystemExit("capabilities portalVersion mismatch")
if data.get("variant") != "v0.portal4b-mp4-control-polish":
...
if data.get("nativeWebRtcRuntime") is not False:
    raise SystemExit("nativeWebRtcRuntime should be false for v0.portal4b")
if data.get("dtlsSrtp") is not False:
    raise SystemExit("dtlsSrtp should be false for v0.portal4b")
...
PY
  ...
  echo "result=PORTAL_SMOKE_V0PORTAL4B_COMPLETED"
} 2>&1 | tee "$REPORT"
