...
VARIANT="${VARIANT:-v0.portal2.2-smartisax-remote-screen-control-bufferfix}"
SOURCE_VARIANT="v0.portal2.1-smartisax-remote-screen-control-privapi"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.portal2.1-smartisax-remote-screen-control-privapi.sparse.img}"
SOURCE_SPARSE_SHA256="5a236cd8a63f4a2734a80efa5fbf733f8557371d97c3c0086a0a7be72279667e"
SOURCE_SYSTEM_B="${SOURCE_SYSTEM_B:-${ROOT_DIR}/hard-rom/build/system-otatrust-v0.portal2.1-smartisax-remote-screen-control-privapi.img}"
SOURCE_SYSTEM_B_SHA256="52ad3fdb4330cd8d30427401a19d97e208fb1737782660b48c463c141c0e7dcf"
...
EXPECTED_SERVICES_JAR_SHA256="366bf1c3d0d25d195a51a265064d4a648b3656f4d703e507e86652072262e864"
...
PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a394814}"
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-22 22:35:00 +0800; invalidates Smartisax package scan/cache after SurfaceControl ScreenshotGraphicBuffer conversion repair}"

PURPOSE="Repair Smartisax LAN remote screen/control by converting SurfaceControl ScreenshotGraphicBuffer results to Bitmap on top of v0.portal2.1."
RESULT_NAME="PASS_BUILD_V0PORTAL22_SMARTISAX_REMOTE_SCREEN_CONTROL_BUFFERFIX"

usage() {
  cat <<'USAGE'
Usage:
  tools/r2-hardrom-build-v0.portal2.2-smartisax-remote-screen-control-bufferfix.sh

Builds a system_b-only repair candidate on top of v0.portal2.1. It updates the
Smartisax priv-app APK and privapp whitelist in place, keeps the same portal
HTTP pairing contract, keeps the privileged InputManager path, and changes the
SurfaceControl screenshot path to accept ScreenshotGraphicBuffer results. It keeps
services.jar unchanged, rebuilds system_b AVB/FEC roots=2, and patches that
system_b image into the v0.portal2.1 sparse super. It does not touch a live
device.
USAGE
}
