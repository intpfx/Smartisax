...
VARIANT="${VARIANT:-v0.portal4a-webrtc-rtp-probe}"
SOURCE_VARIANT="v0.portal3c-h264-webcodecs-playback"
SOURCE_SPARSE="${SOURCE_SPARSE:-${ROOT_DIR}/hard-rom/build/super-otatrust-v0.portal3c-h264-webcodecs-playback.sparse.img}"
SOURCE_SPARSE_SHA256="41f15da085dcbe272c990ccfff046931fd7adc00f31215e413a4d8267255827c"
SOURCE_SYSTEM_B="${SOURCE_SYSTEM_B:-${ROOT_DIR}/hard-rom/build/system-otatrust-v0.portal3c-h264-webcodecs-playback.img}"
SOURCE_SYSTEM_B_SHA256="d51192fe6df61783239b46ce487b516cc2e22202233cccdec29daf5f2bc36b1b"
...
PACKAGE_DIR_MTIME_HEX="${PACKAGE_DIR_MTIME_HEX:-0x6a3a6e40}"
PACKAGE_DIR_MTIME_NOTE="${PACKAGE_DIR_MTIME_NOTE:-2026-06-23 20:30:00 +0800; invalidates Smartisax package scan/cache after WebRTC/RTP probe APK update}"

PURPOSE="Add the first Smartisax Portal WebRTC signaling and H.264 RTP packetizer probe on top of live-proven v0.portal3c while retaining MP4 browser playback, raw H.264, PNG, and privileged input fallback."
RESULT_NAME="PASS_BUILD_V0PORTAL4A_WEBRTC_RTP_PROBE"
...
Builds a system_b-only Smartisax Portal candidate on top of v0.portal3c. It
...
/api/webrtc/offer and /api/rtp/h264 diagnostic endpoints. The accepted
/api/video/mp4 browser playback path, raw /api/video/h264 endpoint,
/api/media/capabilities, PNG screen, and privileged input stay intact.
It rebuilds system_b AVB/FEC roots=2 and patches that system_b image into the
v0.portal3c sparse super. It does not touch a live device.
USAGE
}
