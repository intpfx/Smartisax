...
export EXPECTED_VERSION_CODE="57"
export EXPECTED_VERSION_NAME="0.7.6"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.agent0.6-accessibility-tree"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0AGENT06_ACCESSIBILITY_TREE"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0AGENT06_ACCESSIBILITY_TREE"
...
{
  echo
  echo "## agent0.6 extra offline checks"
  ...
  grep -R -q 'v0.agent0.6-accessibility-tree' "$decode_dir" || { echo "error: agent0.6 variant marker missing" >&2; exit 1; }
  ...
  echo "agent06_extra_offline_checks=ok"
} 2>&1 | tee -a "$report"
