...
export EXPECTED_VERSION_CODE="46"
export EXPECTED_VERSION_NAME="0.6.29"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal6c-visible-screenbox"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal6b_draw_urgent_boost"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal6b_draw_urgent_boost"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL6C_VISIBLE_SCREENBOX"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL6C_VISIBLE_SCREENBOX"
