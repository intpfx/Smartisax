...
export EXPECTED_VERSION_CODE="50"
export EXPECTED_VERSION_NAME="0.6.33"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal6g-rvfc-media-tail"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL6G_RVFC_MEDIA_TAIL"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL6G_RVFC_MEDIA_TAIL"
