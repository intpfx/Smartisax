...
export VARIANT="v0.agent0.9-worker-a11y-targets"
export EXPECTED_VERSION_CODE="60"
export EXPECTED_VERSION_NAME="0.7.9"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.agent0.9-worker-a11y-targets"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0AGENT09_WORKER_A11Y_TARGETS"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0AGENT09_WORKER_A11Y_TARGETS"

SYSTEM_IMG="${ROOT_DIR}/hard-rom/build/system-otatrust-${VARIANT}.img"
EXPECTED_SYSTEM_SHA256="65867365776dbf8d4c73c1ab26a16f8e9d8bf5e47758909b811b698586cf589f"
...
{
  echo
  echo "## agent0.9 extra offline checks"
  ...
  grep -R -q 'v0.agent0.9-worker-a11y-targets' "$decode_dir" || { echo "error: agent0.9 variant marker missing" >&2; exit 1; }
  ...
  echo "agent09_extra_offline_checks=ok"
} 2>&1 | tee -a "$report"
