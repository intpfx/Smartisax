...
export EXPECTED_VERSION_CODE="35"
export EXPECTED_VERSION_NAME="0.6.18"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal5r-refresh-rate-60-90hz"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal5r_refresh_rate_60_90hz"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal5r_refresh_rate_60_90hz"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5R_REFRESH_RATE_60_90HZ"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5R_REFRESH_RATE_60_90HZ"
