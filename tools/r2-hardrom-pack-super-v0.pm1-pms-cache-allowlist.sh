...
PURPOSE="Patch the v0.pm1 system_b image into the live-proven v0.pm0 sparse super without rebuilding unrelated partitions."
RESULT_NAME="PASS_PACK_SUPER_V0PM1_PMS_CACHE_ALLOWLIST"
...
Packs the offline-built v0.pm1 system_b image into a flashable sparse super by
rewriting only the system_b logical partition range inside the live-proven
v0.pm0 sparse super. This script does not touch a live device.
USAGE
}
