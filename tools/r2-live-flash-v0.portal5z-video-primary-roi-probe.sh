...
RESULT_NAME="PASS_FLASH_V0PORTAL5Z_VIDEO_PRIMARY_ROI_PROBE"
IMAGE="${ROOT_DIR}/hard-rom/build/super-otatrust-v0.portal5z-video-primary-roi-probe.sparse.img"
EXPECTED_IMAGE_SHA256="3a622e32a540c077075d0e9259a6245338e38a24b65342a09c212a6032fda0df"
CONFIRM_PHRASE="确认刷入 v0.portal5z-video-primary-roi-probe B 槽"
INSPECT_DIR="${ROOT_DIR}/hard-rom/inspect/${VARIANT}"
VERIFY_SCRIPT="${ROOT_DIR}/tools/r2-verify-v0.portal5z-video-primary-roi-probe.sh"
PREFLIGHT_SCRIPT="${ROOT_DIR}/tools/r2-live-flash-preflight.sh"

usage() {
  cat <<USAGE
Usage:
  tools/r2-live-flash-v0.portal5z-video-primary-roi-probe.sh --confirm "${CONFIRM_PHRASE}"
