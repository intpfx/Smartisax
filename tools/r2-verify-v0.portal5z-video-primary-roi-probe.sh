...
export EXPECTED_VERSION_CODE="43"
export EXPECTED_VERSION_NAME="0.6.26"
export EXPECTED_NATIVE_SYSTEM_WEBRTC_LIBS="1"
export EXPECTED_PORTAL_VARIANT_MARKER="v0.portal5z-video-primary-roi-probe"
...
export EXPECTED_WEBRTC_QUALITY_REASON_MARKER="portal5z_video_primary_roi_probe"
export EXPECTED_WEBRTC_BITRATE_TUNE="1"
export EXPECTED_WEBRTC_DEFAULT_UI="1"
export EXPECTED_WEBRTC_RUNTIME_TUNING="1"
export EXPECTED_WEBRTC_RUNTIME_REASON_MARKER="portal5z_video_primary_roi_probe"
...
export OFFLINE_RESULT_NAME="PASS_OFFLINE_IMAGE_V0PORTAL5Z_VIDEO_PRIMARY_ROI_PROBE"
export READ_ONLY_RESULT_NAME="PASS_READ_ONLY_V0PORTAL5Z_VIDEO_PRIMARY_ROI_PROBE"
