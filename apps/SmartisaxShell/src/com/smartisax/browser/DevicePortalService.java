...
public final class DevicePortalService extends Service {
    ...
    private static final String PORTAL_VERSION = "0.6.9";
    private static final String PORTAL_VARIANT = "v0.portal5j.2-projection-binder-transact";
    ...
    private static final class PortalServer implements Runnable {
        ...
        private JSONObject statusJson() throws JSONException {
            ...
            json.put("webrtcCodec", "H264-preferred-browser");
        ...
        private JSONObject mediaCapabilitiesJson() throws JSONException {
            ...
            preferred.put("codec", "H264");
            preferred.put("mime", "video/avc");
            ...
            preferred.put("minimumTarget", "1080p30");
            preferred.put("defaultTarget", "1080p60");
            ...
            preferred.put("reason", "portal5j_projection_texture_zero_copy_probe_1080p60");
